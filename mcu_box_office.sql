...
-- The Multiverse Saga was a good start, considering No Way Home's performance (THE CROSSOVER), but instead of saturating the market with new characters they should have introduced the Fox and Sony characters into the Multiverse. No Way Home is one of very few movies that have broke a billion in box office since Endgame. 
-- They would not have saturated the market any further this way and people would still be filling the seats in theaters. People would love to see the crossover. That is what got people into the first phase to begin with. The crossover between heroes. You can have the audience relive the magic of the first phase with the crossover of universes. But this time they are reliving the nostalgia of the prior films too. This is hands down the best path to take. It will bring back the magic of the MCU.
-- Then eventually when that starts wearing thin, you can finally do the MCU/DCEU crossover. People love crossovers. Civil War was another major crossover. The first one to happen outside an Avengers movie and it was also a major success. I am telling you, it is the crossover people like.
...
-- X-Men vs Avengers may have been the best bet for the phase 4 Avengers Movie. They had many fights in the comics and both are formidable enough for it to be an equal fight.
-- I would also suggest having the Russo brothers on more projects. They directed 4 movies in the MCU and all of them were a critical and financial success, one of them breaking the record for highest box office of all time after the previous 10 year reign. The Winter Soldier, Civil War, Infinity War, and Endgame.  
